...
const PREFIX = 'catch.module.me.PauseTaxesView';
export const COPY = {
...
export const PauseTaxesView = ({ onCancel, onCompleted, breakpoints }) => (
  <ToggleGoal
    goalType="tax"
    goalName="Taxes"
        ...
        <View style={styles.get('CenterColumn')}>
          <View style={styles.get(['LgBottomGutter', 'TopGutter'])}>
            <Icon
              ...
              size={48}
            />
            <Icon name="circle-pause" style={localStyles.icon} />
          </View>
          <Text
            style={styles.get(
...
PauseTaxesView.propTypes = {
  onCancel: PropTypes.func.isRequired,
  onCompleted: PropTypes.func.isRequired,
  breakpoints: PropTypes.object.isRequired,
};

export default withDimensions(PauseTaxesView);
