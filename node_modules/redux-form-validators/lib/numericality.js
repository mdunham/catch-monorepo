...
var numericality = (0, _helpers.memoize)(function () {
  ...
  return (0, _helpers.prepare)(ifCond, unless, allowBlank, function (value) {
    ...
    if (int && +value % 1) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'notAnInteger'));
    }

    if (null !== equal && +value !== equal) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'equalTo', {
        count: equal
      }));
    }

    if (null !== diff && +value === diff) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'otherThan', {
        count: diff
      }));
    }

    if (null !== greater && +value <= greater) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'greaterThan', {
        count: greater
      }));
    }

    if (null !== greaterOrEqual && +value < greaterOrEqual) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'greaterThanOrEqualTo', {
        count: greaterOrEqual
      }));
    }

    if (null !== less && +value >= less) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'lessThan', {
        count: less
      }));
    }

    if (null !== lessOrEqual && +value > lessOrEqual) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'lessThanOrEqualTo', {
        count: lessOrEqual
      }));
    }
