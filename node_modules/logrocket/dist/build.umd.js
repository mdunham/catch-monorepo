  ...
  return (
    ...
    function (module, exports, __webpack_require__) {
      ...
      function registerXHR(_ref) {
        ...
        var unsubscribedFromXhr = false; // const LOGROCKET_XHR_LABEL = 'logrocket_xhr';
          ...
          var xhrListeners = {
            readystatechange: function readystatechange() {
              ...
              if (xhrObject.readyState === 4) {
                ...
                var body = void 0; // IE 11 sometimes throws when trying to access a large responses:
    ...
    function (module, exports) {
      ...
      exports.default = typeof performance !== 'undefined' && performance.now ? performance.now.bind(performance) : function () {
    ...
    function (module, exports, __webpack_require__) {
      ...
      function registerNetwork(logger) {
        ...
        var unsubFetch = (0, _registerFetch2.default)({
    ...
    function (module, exports, __webpack_require__) {
      ...
      function attach(env) {
        ...
        }(env.fetch); // Forward the polyfill propery from fetch (set by github/whatwg-fetch).
      ...
      (function (global) {
        ...
        var Handler = function () {
          ...
          _createClass(Handler, [{
            key: 'uninstall',
            value: function uninstall() {
              _TraceKit2.default.report.unsubscribe(this._errorHandler); // restore any wrapped builtins
